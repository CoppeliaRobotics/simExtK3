...
{ // This is called just once, at the start of V-REP.
    ...
    {
        std::cout << "Sorry, your V-REP copy is somewhat old, V-REP 3.4.0 rev9 or higher is required. Cannot start 'K3' plugin.\n";
        unloadVrepLibrary(vrepLib);
        return(0);
    }
    ...
    // version 8 is for V-REP versions after V-REP 3.4.0 (new API notation)
}
